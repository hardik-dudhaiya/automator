...
public class MainActivity extends AppCompatActivity {
    ...
    private void handleClicks() {
        ...
        _rlvCreateNew.setOnClickListener(V -> startActivity(new Intent(MainActivity.this, CreateMacroActivity.class)));

        _rlvExit.setOnClickListener(V -> onBackPressed());

        _rlvExport.setOnClickListener(V -> {
            final Dialog dialog = new Dialog(MainActivity.this, R.style.creativeDialogTheme);
