...
public class BatterySaverTriggerDialogManager extends DialogManager {

    Context context;

    public BatterySaverTriggerDialogManager(Context context) {
        super(context);
    ...
    private void showBatterySaverDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                addTriggerEvent(2, new EventValue(option, null));
            }
        });
