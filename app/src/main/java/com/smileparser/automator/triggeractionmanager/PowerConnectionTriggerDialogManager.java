...
public class PowerConnectionTriggerDialogManager extends DialogManager {

    public PowerConnectionTriggerDialogManager(Context context) {
        super(context);
    }
    ...
    private void showPowerConnectionDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                addTriggerEvent(4, new EventValue(option, null));
            }
        });
